...
if __name__ == '__main__':    
    ...
    save_path = '/data/timer/Comparison/VIF/Fusion_Benchmark/Results/PMGI'
    model_path = '/data/timer/Comparison/VIF/Fusion_Benchmark/PMGI/checkpoint/CGAN_120/CGAN.model-1'
    main(
        Method='PMGI', 
